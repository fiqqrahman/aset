            ...
            <header
                ...
                <div class="flex items-center gap-4 w-1/3">
                    <div class="relative w-full">
                        ...
                        <svg class="w-4 h-4 text-slate-400 absolute left-2.5 top-2" fill="none"
            ...
            <main class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Rusak
                                    Berat / Penghapusan</span>
                                <div
                    ...
                    <div
                        ...
                        <div>
                            <div class="p-4 border-b border-slate-100 flex items-center justify-between">
                                <div>
                                    <h3 class="text-xs font-bold text-slate-900 uppercase tracking-wider">Aktivitas &
                                        Log
                                        Rekonsiliasi Aset Terbaru</h3>
                                    <p class="text-[11px] text-slate-500">Pembaruan kondisi fisik dan mutasi barang
                                        oleh
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-left border-collapse">
                                    ...
                                    <tbody class="divide-y divide-slate-100 text-xs">
                                        ...
                                        <tr class="hover:bg-slate-50/80 transition-colors">
                                            <td class="py-3 px-4 font-semibold text-slate-900">SMPN 2 Palangka Raya
                                            </td>
